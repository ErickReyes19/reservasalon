                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: end">
                            <a href="{{ route('extra.edit', $extra->id) }}"><button class="btn btn-dark"><i class="fa-solid fa-pen-to-square" style="color: #ffffff;"></i></button></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
            ...
            $('.btn-eliminar').on('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        var url = "{{ route('extra.desactive', ':id') }}";
